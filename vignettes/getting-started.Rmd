...
This example demonstrates rendering polygons with centroids, useful for spatial data visualization like cell segmentation:
...
- Read the [deck.gl documentation](https://deck.gl/docs) for all layer types
- Check the [rDeckgl GitHub](https://github.com/TiRizvanov/rDeckgl) for updates
