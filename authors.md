...
- **Timur Rizvanov**. Author, maintainer.
...
Rizvanov T, Ruiz E, Dries R (2026). *rDeckgl: Deck.gl for R*. R package
version 0.1.0, <https://github.com/TiRizvanov/rDeckgl>.

    @Manual{,
      title = {rDeckgl: Deck.gl for R},
